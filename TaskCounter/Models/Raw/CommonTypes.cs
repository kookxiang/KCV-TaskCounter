namespace TaskCounter.Models.Raw {
    ...
    public class Api_Kouku {
        ...
        public Api_Stage1 api_stage1 {
            get; set;
        }
        public Api_Stage2 api_stage2 {
            get; set;
        }
    ...
    public class Api_Stage2 {
        ...
        public Api_Air_Fire api_air_fire {
            get; set;
        }
    }
    ...
    public class Api_Stage3 {
        ...
        public double[] api_fdam {
            get; set;
        }
        public double[] api_edam {
            get; set;
        }
    }
    ...
    public class Raigeki {
        ...
        public double[] api_fydam {
            get; set;
        }
        public double[] api_eydam {
            get; set;
        }
        public int[] api_fcl {
            get; set;
    ...
    public class Hougeki {
        ...
        public object[] api_si_list {
            get; set;
        }
        public object[] api_cl_list {
            get; set;
        }
