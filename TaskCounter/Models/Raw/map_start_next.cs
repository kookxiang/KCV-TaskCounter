namespace TaskCounter.Models.Raw {
    public class map_start_next {
        ...
        public Api_Eventmap api_eventmap {
            get; set;
        }
        ...
        public Api_Enemy api_enemy {
            get; set;
        }
        public Api_Happening api_happening {
            get; set;
        }
    }
    ...
    public class Api_Enemy {
        public int api_enemy_id {
            get; set;
        }
        public int api_result {
            get; set;
        }
        public string api_result_str {
            get; set;
        }
    }
